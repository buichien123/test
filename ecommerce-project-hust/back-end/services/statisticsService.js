...
const getProductStats = async (startDate = null, endDate = null) => {
  let dateFilter = "";
  const params = [];
  ...
  // Low stock products (not affected by date range)
...
const getCategoryStats = async (startDate = null, endDate = null) => {
  let dateFilter = "";
  const params = [];
...
const getCustomerStats = async (startDate = null, endDate = null) => {
  let dateFilter = "";
  const params = [];
