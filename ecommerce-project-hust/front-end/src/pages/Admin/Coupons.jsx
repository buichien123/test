...
const Coupons = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setDeleteConfirm({ isOpen: false, couponId: null })
      fetchCoupons()
    } catch (error) {
      ...
      <div className="card p-4 mb-6 shadow-md">
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-colors ${statusFilter === 'inactive'
                ? 'bg-primary-600 text-white'
                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-colors ${statusFilter === 'expired'
                ? 'bg-primary-600 text-white'
                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
