...
const AdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/admin/statistics', icon: PresentationChartLineIcon, label: 'Báo cáo thống kê' },
    ...
    { path: '/admin/blog', icon: DocumentTextIcon, label: 'Bài viết' },
    { path: '/admin/blog/comments', icon: ChatBubbleLeftIcon, label: 'Bình luận' }
  ]
